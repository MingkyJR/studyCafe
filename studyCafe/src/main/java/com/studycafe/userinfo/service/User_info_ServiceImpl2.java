...
import com.studycafe.userinfo.repository.User_info_repositoryImpl2;

@Service
public class User_info_ServiceImpl2 implements User_info_Service2 {

	@Inject
	User_info_repositoryImpl2 user_info_repositoryImpl2;
