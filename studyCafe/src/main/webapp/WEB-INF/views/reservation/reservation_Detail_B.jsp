...
<body>
	<h2 class="h2" id="tt">스터디룸 B 예약 상세페이지입니다</h2>
	<hr style="height: 1px; border: 0; background: #aaa;" />
	<div class="container">
	
	<div class="aside">
	<img id="img" src="<%=request.getContextPath()%>/resources/assets/images/reservation/room_b.jpg">
	</div>
	<div class="contant">
