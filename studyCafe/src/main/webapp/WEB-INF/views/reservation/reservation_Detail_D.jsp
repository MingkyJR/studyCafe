...
<body>
	<h2>D룸 예약 상세페이지입니다</h2>
	
	<hr/>
	<form action="${contextPath}/scafe/reservationSuccess" method="post" name="form" onsubmit="return check(this)" >
	...
	<input type="hidden" name="r_price" value="20000"/>
	...
	<h3>시간 선택</h3>
	<input type="checkbox" id ="rs_time1" name="rs_time1" value="09:00~11:00" class="rtt"> 09:00~11:00 <br/>
	<input type="checkbox" id ="rs_time2" name="rs_time2" value="11:00~13:00" class="rtt"> 11:00~13:00 <br/>
	<input type="checkbox" id ="rs_time3" name="rs_time3" value="13:00~15:00" class="rtt"> 13:00~15:00 <br/>
	<input type="checkbox" id ="rs_time4" name="rs_time4" value="15:00~17:00" class="rtt"> 15:00~17:00 <br/>
	<input type="checkbox" id ="rs_time5" name="rs_time5" value="17:00~19:00" class="rtt"> 17:00~19:00 <br/>
	<input type="checkbox" id ="rs_time6" name="rs_time6" value="19:00~21:00" class="rtt"> 19:00~21:00 <br/>
