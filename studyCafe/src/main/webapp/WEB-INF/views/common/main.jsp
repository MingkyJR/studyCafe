...
<body>
	<div class="banner_wrap">
		<div class="banner">
			...
			<div class="btn1" onclick="location.href='<%=request.getContextPath()%>/reservation/Main'"><a href="<%=request.getContextPath()%>/reservation/Main" style="color: #F6F4E8">예약하러가기</a></div>
		</div>
	</div>
	<div class="summary">
