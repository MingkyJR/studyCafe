...
$(document).ready( function(){
	 ...
	 $("#btn").click( function() {
		...
		if($("#u_grade").val()!=1 && $("#u_grade").val()!=999){ 
...
<form action="<%=request.getContextPath() %>/user/adminModiUser" method="post" class="login-form" name="loginFrm">
	
	회원번호 	<input type="text" id="u_number" name="u_number" readonly value="${detailUser.u_number}" /><br/>
	아이디	<input type="text" name="u_id" id="u_id" readonly value="${detailUser.u_id }"><br/>
	비밀번호 <input type="text" name="u_pass" id="u_pass" value="${detailUser.u_pass }" ><br/>
	이름		<input type="text" name="u_name" id="u_name"  value="${detailUser.u_name }"><br/>
	성별		<br/>
		<c:if test="${detailUser.u_gender eq '남' }">
		...
		<c:if test="${detailUser.u_gender eq '여' }">
	...
	전화번호	<input type="text" name="u_tell" id="u_tell"  value="${detailUser.u_tell}" oninput="autoHyphen2(this)" maxlength="13"><br/>
	회원등급 	<input type="number" name="u_grade" id="u_grade"  value="${detailUser.u_grade }"><br/>
